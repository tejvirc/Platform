...
namespace Aristocrat.Monaco.Kernel.MarketConfig.Models.Accounting
{
    ...
    public class TenderInFieldset
    {
        ...
        public CheckCreditsStrategy CheckCreditsIn { get; set; }
    ...
    /// <summary>
    /// Large win key-off strategy Enumeration
    /// </summary>
    public enum KeyOffType
    {
        /// <summary>Local Handpay</summary>
        LocalHandpay,
        /// <summary>Local Voucher</summary>
        LocalVoucher,
        /// <summary>Local WAT</summary>
        LocalWat,
        /// <summary>Local Credit</summary>
        LocalCredit,
        /// <summary>Remote Handpay</summary>
        RemoteHandpay,
        /// <summary>Remote Voucher</summary>
        RemoteVoucher,
        /// <summary>Remote WAT</summary>
        RemoteWat,
        /// <summary>Remote Credit</summary>
        RemoteCredit,
    ...
    public class HandpayFieldset
    {
        ...
        public KeyOffType LargeWinKeyOffStrategy { get; set; }
