namespace Aristocrat.Monaco.Bootstrap
{
    ...
    [SuppressMessage("Microsoft.Design", "CA1001:TypesThatOwnDisposableFieldsShouldBeDisposable", Justification = "objects disposed of in Shutdown method")]
    internal sealed class Sequencer<T>
    {
        ...
        public void Enqueue(T item)
        {
            ...
            catch (Exception e)
            {
                OnException?.Invoke(
                    this,
                    new SequencerExceptionEventArgs(new SequencerException("Exception occurred when adding item.", e)));
            }
        }
    ...
    public sealed class SequencerException : Exception
    {
        ...
        public SequencerException(string message, Exception innerException)
