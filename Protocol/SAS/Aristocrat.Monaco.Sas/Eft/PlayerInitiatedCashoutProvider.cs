namespace Aristocrat.Monaco.Sas.Eft
{
    ...
    public class PlayerInitiatedCashoutProvider : IPlayerInitiatedCashoutProvider
    {
        ...
        private void SubscribeEvents()
        {
            ...
            _eventBus.Subscribe<TransferOutCompletedEvent>(this, (_) => TryReportingPlayerInitiatedCashoutException());
            ...
            _eventBus.Subscribe<TransferOutFailedEvent>(this, (_) => TryReportingPlayerInitiatedCashoutException());
        }
        ...
        private void TryReportingPlayerInitiatedCashoutException()
        {
