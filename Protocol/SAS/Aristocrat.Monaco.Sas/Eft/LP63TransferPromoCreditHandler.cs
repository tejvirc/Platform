namespace Aristocrat.Monaco.Sas.Eft
{
    ...
    ///     Handles LP 63, credit transfers to the EGM. Most of the workflow logic is handled in
    ///     <see cref="IEftStateController". />
    /// </summary>
    public class LP63TransferPromoCreditHandler : ISasLongPollHandler<EftTransactionResponse, EftTransferData>,
        IEftTransferHandler
    {
        /// <inheritdoc cref="ISasLongPollHandler" />
        public List<LongPoll> Commands { get; } = new() { LongPoll.EftTransferPromotionalCreditsToMachine };
        ...
        /// <summary>
        ///     Creates and returns a new instance of LP63 handler.
        /// </summary>
        public LP63TransferPromoCreditHandler(
        ...
        {
            //Check if last transaction of type LP63 needs recovery.
