namespace Aristocrat.Monaco.Sas.Eft
{
    ...
    ///     Handles LP 6B, Promotional credit transfers to the Host. Most of the workflow logic is handled in
    ///     <see cref="IEftStateController". />
    /// </summary>
    public class LP6BTransferPromotionalCreditsToHostHandler :
        ISasLongPollHandler<EftTransactionResponse, EftTransferData>,
        IEftTransferHandler
    {
        ...
        /// <summary>
        ///     Creates and returns a new instance of LP6B handler.
        /// </summary>
        public LP6BTransferPromotionalCreditsToHostHandler(
        ...
        {
            //Check if last transaction of type LP6B needs recovery.
        ...
        {
            return Localizer.For(CultureFor.Player).GetString(ResourceKeys.EftTransferOutInProgress);
        }

        /// <inheritdoc />
        public bool ProcessTransfer(ulong amountToBeTransferred, int transactionNumber)
        {
            return _provider.DoEftOff(
        ...
        {
            return _provider.GetAcceptedTransferOutAmount(AccountType.NonCash);
        }
        ...
        public List<LongPoll> Commands => new() { LongPoll.EftTransferPromotionalCreditsToHost };
