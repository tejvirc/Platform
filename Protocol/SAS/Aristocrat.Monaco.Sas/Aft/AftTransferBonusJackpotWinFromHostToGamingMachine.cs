namespace Aristocrat.Monaco.Sas.Aft
{
    ...
    /// <summary>
    ///     Handles transferring Bonus Jackpot Wins from Host to gaming machine
    /// </summary>
    public class AftTransferBonusJackpotWinFromHostToGamingMachine : IAftRequestProcessor
    {
        ...
        /// <summary>
        ///     Instantiates a new instance of the AftTransferBonusJackpotWinFromHostToGamingMachine class
        /// </summary>
        ...
        public AftTransferBonusJackpotWinFromHostToGamingMachine(
        ...
        public AftResponseData Process(AftResponseData data)
        {
            ...
            {
                Logger.Debug("Starting Aft bonus jackpot win to game machine as a task");
        ...
        private Dictionary<Func<bool>, (AftTransferStatusCode code, string message)> InitializeErrorConditions()
        {
            return new Dictionary<Func<bool>, (AftTransferStatusCode code, string message)>
            {
                ...
                },
                {
                    ...
                    (AftTransferStatusCode.NotAValidTransferFunction, "restricted bonus transfers not allowed")
                },
                {
