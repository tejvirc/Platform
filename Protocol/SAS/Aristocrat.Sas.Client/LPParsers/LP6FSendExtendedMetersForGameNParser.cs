namespace Aristocrat.Sas.Client.LPParsers
{
    ...
    /// Command          1           6F        Send Extended Meters for Game N
    ...
    public class LP6FSendExtendedMetersForGameNParser : SendSelectedMetersForGameNParserBase
    {
        /// <inheritdoc />
        public LP6FSendExtendedMetersForGameNParser(SasClientConfiguration configuration)
            : base(LongPoll.SendExtendedMetersForGameN, true, configuration)
        {
        }
    }
}