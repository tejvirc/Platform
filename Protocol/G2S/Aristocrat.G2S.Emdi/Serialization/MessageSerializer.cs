namespace Aristocrat.G2S.Emdi.Serialization
{
    ...
    /// <summary>
    /// Implements the <see cref="IMessageSerializer"/> interface
    /// </summary>
    public class MessageSerializer : IMessageSerializer
    {
        ...
        /// <inheritdoc />
        [SuppressMessage("Microsoft.Usage", "CA2202:Do not dispose objects multiple times", Justification = "memory stream disposal is ok")]
