namespace Aristocrat.Monaco.G2S.Consumers
{
    ...
    public class PlayerSessionStartedConsumer : Consumes<SessionStartedEvent>
    {
        ...
        public PlayerSessionStartedConsumer(
            IG2SEgm egm,
        ...
        public override void Consume(SessionStartedEvent theEvent)
        {
            ...
            _ipService.OnPlayerSessionStarted();
        }
    }
}
