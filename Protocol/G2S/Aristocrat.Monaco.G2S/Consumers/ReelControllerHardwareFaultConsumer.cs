namespace Aristocrat.Monaco.G2S.Consumers
{
    ...
    public class ReelControllerHardwareFaultConsumer : ReelBaseConsumer<HardwareFaultEvent>
    {
        public ReelControllerHardwareFaultConsumer(
            IG2SEgm egm,
        ...
        {
            AddFault(CabinetFaults.ReelControllerFault);
        }
    }
}