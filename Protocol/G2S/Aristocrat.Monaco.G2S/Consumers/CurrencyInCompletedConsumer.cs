namespace Aristocrat.Monaco.G2S.Consumers
{
    ...
    /// <summary>
    ///     Handles the Note Acceptor <see cref="CurrencyInCompletedEvent" />
    /// </summary>
    public class CurrencyInCompletedConsumer : NoteAcceptorConsumerBase<CurrencyInCompletedEvent>
    {
        ...
        public CurrencyInCompletedConsumer(
            ...
            : base(egm, commandBuilder, eventLift, EventCode.G2S_NAE114)
        {
            _egm = egm;
        ...
        /// <inheritdoc />
        protected override bool ReportEvent(CurrencyInCompletedEvent theEvent)
        {
            // The event is reported for success and failure. If the amount is zero it's a failure(?)
            return theEvent.Amount > 0 && base.ReportEvent(theEvent);
        }
