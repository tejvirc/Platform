namespace Aristocrat.Monaco.Protocol.Common.Communication
{
    ...
    public class CustomUdpClient : IDisposable
    {
        ...
        /// <summary>
        ///     Initializes a new instance of the <see cref="CustomUdpClient"/> class.
        /// </summary>
        /// <param name="address">IP address.</param>
        /// <param name="port">Port number.</param>
        public CustomUdpClient(IPAddress address, int port)
        ...
        /// <param name="address">IP address.</param>
        /// <param name="port">Port number.</param>
        public CustomUdpClient(string address, int port)
