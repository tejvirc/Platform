namespace Aristocrat.Monaco.Mgam.Consumers
{
    ...
    /// <summary>
    ///     Handles the Printer <see cref="DisconnectedEvent" /> event.
    /// </summary>
    public class PrinterDisconnectedConsumer : Consumes<DisconnectedEvent>
    {
        ...
        public PrinterDisconnectedConsumer(
            ILockup lockup,
            ILogger<PrinterDisconnectedConsumer> logger,
        ...
        {
            _logger.LogDebug("Employee login required when printer disconnected");
