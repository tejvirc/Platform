namespace Aristocrat.Mgam.Client.Messaging
{
    ...
    /// <summary>
    ///     VLTs can use this broadcast message to obtain valid GUIDs. These GUIDs can then be assigned
    ///     by the VLT to Installations, Devices, etc.
    /// </summary>
    public class RequestGuid : Request
    {
        ...
        public RequestGuid(IPEndPoint responseAddress)
        {
