namespace Aristocrat.Monaco.Mgam.Common
{
    ...
    {
        private const int NamespaceBasedMd5 = 3;
        private const int NamespaceBasedSha1 = 5;
        ...
        /// <param name="value">The name (within that namespace).</param>
        /// <returns>A UUID derived from the namespace and name.</returns>
        public static Guid Create(Guid namespaceId, string value)
        {
            return Create(namespaceId, value, NamespaceBasedSha1);
        }
        ...
        {
            return Create(namespaceId, nameBytes, NamespaceBasedSha1);
        }
        ...
        {
            if (version != NamespaceBasedMd5 && version != NamespaceBasedSha1)
            {
