namespace Aristocrat.Bingo.Client.Messages
{
    ...
    public interface IProgressiveCommandService
    {
        /// <summary>
        ///     Opens the client for progressive commands
        /// </summary>
        ...
        Task<bool> HandleCommands(string machineSerial, int gameTitleId, CancellationToken cancellationToken = default);
    }
}
