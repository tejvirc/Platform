namespace Aristocrat.Monaco.Gaming.Tests.ConsumerTests
{
    ...
    [TestClass]
    public class LinkedProgressiveRefreshedConsumerTests
    {
        ...
        private LinkedProgressiveRefreshedConsumer _target;
        ...
        public void MyTestInitialize()
        {
            ...
            _target = new LinkedProgressiveRefreshedConsumer(
        ...
        public void ConsumeTest()
        {
            ...
            _target.Consume(new LinkedProgressiveRefreshedEvent(levels));

            _errorProvider.Verify(x => x.ClearProgressiveUpdateError(levels), Times.Once);
            _errorProvider.Verify(x => x.ClearProgressiveUpdateError(levels), Times.Once);
