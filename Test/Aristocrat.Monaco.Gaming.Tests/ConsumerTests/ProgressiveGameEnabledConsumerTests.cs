namespace Aristocrat.Monaco.Gaming.Tests.ConsumerTests
{
    ...
    [TestClass]
    public class ProgressiveGameEnabledConsumerTests
    {
        ...
        private ProgressiveGameEnabledConsumer _target;
        ...
        public void MyTestInitialize()
        {
            ...
            _target = new ProgressiveGameEnabledConsumer(_runtime.Object, _properties.Object, _gameProvider.Object);
        }
        ...
        {
            _target = new ProgressiveGameEnabledConsumer(null, _properties.Object, _gameProvider.Object);
        }
        ...
        {
            _target = new ProgressiveGameEnabledConsumer(_runtime.Object, null, _gameProvider.Object);
        }
            ...
            bool flagUpdated)
        {
            ...
            _target.Consume(new ProgressiveGameEnabledEvent(errorGameId, errorDenom, errorBetOption));

            _runtime.Verify(
                x => x.UpdateFlag(RuntimeCondition.ProgressiveError, false),
