namespace Aristocrat.Monaco.Gaming.Tests.Progressives
{
    ...
    public class MysteryProgressiveProviderTests
    {
        ...
        public void Init()
        {
            ...
            _persistentBlock.Setup(x => x.GetOrCreateValue<Dictionary<string, long>>(It.IsAny<string>()))
            ...
            _persistenceProvider.Setup(x => x.GetOrCreateBlock(It.IsAny<string>(), PersistenceLevel.Critical))
