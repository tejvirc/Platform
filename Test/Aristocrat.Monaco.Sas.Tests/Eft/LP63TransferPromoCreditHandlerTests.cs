namespace Aristocrat.Monaco.Sas.Tests.Eft
{
    ...
    /// </summary>
    [TestClass]
    public class LP63TransferPromoCreditHandlerTests
    {
        ...
        private LP63TransferPromoCreditHandler ConstructHandler(bool nullEftStateController, bool nullEftTransferProvider, bool nullEventBus)
        {
            return new LP63TransferPromoCreditHandler(
        ...
        private LP63TransferPromoCreditHandler InitializeHandler()
        {
        ...
        public void CommandTest()
        {
            ...
            var expected = new List<LongPoll> { LongPoll.EftTransferPromotionalCreditsToMachine };
        ...
        public void TestHandle()
        {
            ...
            _transferProvider.Verify(m => m.DoEftOn(It.IsAny<string>(), AccountType.Promo, It.IsAny<ulong>()), Times.Never());
        ...
        public void TestPartialAmountCheckTransferAmount()
        {
            ...
            _transferProvider.Setup(m => m.GetAcceptedTransferInAmount(It.IsAny<ulong>())).Returns((expectedAmount, true));
        ...
        public void TestProcessTransfer()
        {
            ...
            _transferProvider.Verify(m => m.DoEftOn(It.IsAny<string>(), AccountType.NonCash, 50), Times.Once());
        ...
        public void TestCanContinueTransferIfDisabledByHost()
        {
            ...
            Assert.IsTrue(handler.CanContinueTransferIfDisabledByHost());
        }
