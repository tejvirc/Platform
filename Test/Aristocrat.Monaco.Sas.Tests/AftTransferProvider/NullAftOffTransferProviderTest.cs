namespace Aristocrat.Monaco.Sas.Tests.AftTransferProvider
{
    ...
    /// <summary>
    ///     Contains the tests for the NullAftOffTransferProvider class
    /// </summary>
    [TestClass]
    public class NullAftOffTransferProviderTest
    {
        private NullAftOffTransferProvider _target;
        ...
        public void MyTestInitialize()
        {
            ...
            _target = new NullAftOffTransferProvider(
                _sasHost.Object,
                _aftLock.Object,
                _timeService.Object,
