namespace Aristocrat.Monaco.Sas.Tests.Aft
{
    ...
    /// <summary>
    ///     Contains unit tests for the AftTransferBonusCoinOutWinFromHostToGamingMachine class
    /// </summary>
    [TestClass]
    public class AftTransferBonusCoinOutWinFromHostToGamingMachineTest
    {
        private AftTransferBonusCoinOutWinFromHostToGamingMachine _target;
        ...
        public void MyTestInitialize()
        {
            ...
            _target = new AftTransferBonusCoinOutWinFromHostToGamingMachine(_aftProvider.Object, _bonus.Object, _propertiesManager.Object);
        }
        ...
        {
            _target = new AftTransferBonusCoinOutWinFromHostToGamingMachine(null, _bonus.Object, _propertiesManager.Object);
        }
        ...
        {
            _target = new AftTransferBonusCoinOutWinFromHostToGamingMachine(_aftProvider.Object, null, _propertiesManager.Object);
        }
        ...
        {
            _target = new AftTransferBonusCoinOutWinFromHostToGamingMachine(_aftProvider.Object, _bonus.Object, null);
        }
        ...
        {
            _propertiesManager.Setup(x => x.GetProperty(SasProperties.SasFeatureSettings, It.IsAny<object>()))
                .Returns(new SasFeatures { AftBonusAllowed = false, TransferInAllowed = true });
        ...
        [TestMethod]
        public void DoAftBonusCoinWinBonusNotAllowedTest()
        {
            _data.TransferCode = AftTransferCode.TransferRequestFullTransferOnly;
        ...
        [TestMethod]
        public void DoAftBonusCoinWinAwardBonusTest()
        {
            var waiter = new ManualResetEvent(false);

            _data.TransferCode = AftTransferCode.TransferRequestFullTransferOnly;
            _bonus.Setup(m => m.IsAftBonusAllowed(It.IsAny<AftData>())).Returns(true);
            _aftProvider.Setup(m => m.DoBonus()).Returns(Task.CompletedTask).Callback(() => waiter.Set());

            _target.Process(_data);

            waiter.WaitOne();
            _aftProvider.Verify(m => m.DoBonus(), Times.Once);
        }
    }
}
