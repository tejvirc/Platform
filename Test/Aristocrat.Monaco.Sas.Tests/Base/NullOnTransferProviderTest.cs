namespace Aristocrat.Monaco.Sas.Tests.TransferProvider
{
    ...
    /// <summary>
    ///     Contains the tests for the NullOnTransferProvider class
    /// </summary>
    [TestClass]
    public class NullOnTransferProviderTest
    {
        private NullOnTransferProvider _target;
        ...
        public void MyTestInitialize()
        {
            ...
            _target = new NullOnTransferProvider();
        }
