namespace Aristocrat.Monaco.Mgam.Tests.Handlers
{
    ...
    {
        private Mock<ILogger<ExitHandler>> _logger;
        private Mock<IEventBus> _eventBus;
        private Mock<IPlayerTracking> _playerTracking;
        private Mock<ILockup> _lockup;
        private ExitHandler _target;

        [TestInitialize]
        public void MyTestInitialize()
        {
            _logger = new Mock<ILogger<ExitHandler>>(MockBehavior.Default);
        ...
        public void TestHandlerPublishesExitEventOnLoggedOffAndLocked()
        {
            ...
            var result = _target.Handle(new Exit());
            _eventBus.Verify();
        ...
        {
            _target = new ExitHandler(_logger.Object, _eventBus.Object, _playerTracking.Object, _lockup.Object);
        }
    }
}
