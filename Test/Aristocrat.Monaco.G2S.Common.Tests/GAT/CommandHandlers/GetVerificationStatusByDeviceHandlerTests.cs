namespace Aristocrat.Monaco.G2S.Common.Tests.GAT.CommandHandlers
{
    ...
    [TestClass]
    public class GetVerificationStatusByDeviceHandlerTests
    {
        ...
        {
            new GetVerificationStatusByDeviceHandler(
                null,
        ...
        public void ThrowIfComponentVerificationRequestNotFound()
        {
            ...
            handler.Execute(new GetVerificationStatusByDeviceArgs(1, 1));
        }

        [TestMethod]
        [ExpectedException(typeof(DeviceIdNotCorrespondingVerificationIdException))]
        public void ThrowIfDeviceIdNotCorrespondingVerificationId()
        {
            this.verificationRequestRepositoryMock
                .Setup(x => x.Get(It.IsAny<DbContext>(), It.IsAny<Expression<Func<GatVerificationRequest, bool>>>()))
                .Returns(
        ...
        public void ComponentVerificationRequestCompletedTest()
        {
            ...
            var result = handler.Execute(new GetVerificationStatusByDeviceArgs(2, 1));
