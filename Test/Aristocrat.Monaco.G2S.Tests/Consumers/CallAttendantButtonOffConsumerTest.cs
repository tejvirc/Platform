namespace Aristocrat.Monaco.G2S.Tests.Consumers
{
    ...
    public class CallAttendantButtonOffConsumerTest
    {
        ...
        {
            var consumer = new CallAttendantButtonOffConsumer(null, null, null);
        ...
        public void WhenCommandBuilderIsNullExpectException()
        {
            ...
            var consumer = new CallAttendantButtonOffConsumer(egm.Object, null, null);
        ...
        public void WhenEventLiftIsNullExpectException()
        {
            ...
            var consumer = new CallAttendantButtonOffConsumer(egm.Object, builder.Object, null);
        ...
        public void WhenParamsAreValidExpectSuccess()
        {
            ...
            var consumer = new CallAttendantButtonOffConsumer(egm.Object, builder.Object, lift.Object);
        ...
        public void WhenConsumeExpectRaiseEvent()
        {
            ...
            consumer.Consume(new CallAttendantButtonOffEvent());
