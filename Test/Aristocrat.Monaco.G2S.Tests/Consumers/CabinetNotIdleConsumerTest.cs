namespace Aristocrat.Monaco.G2S.Tests.Consumers
{
    ...
    [TestClass]
    public class CabinetNotIdleConsumerTest
    {
        [TestInitialize]
        ...
        {
            var consumer = new CabinetNotIdleConsumer(null, null, null);
        ...
        public void WhenCommandBuilderIsNullExpectException()
        {
            ...
            var consumer = new CabinetNotIdleConsumer(egm.Object, null, null);
        ...
        public void WhenEventLiftIsNullExpectException()
        {
            ...
            var consumer = new CabinetNotIdleConsumer(egm.Object, builder.Object, null);
        ...
        public void WhenParamsAreValidExpectSuccess()
        {
            ...
            var consumer = new CabinetNotIdleConsumer(egm.Object, builder.Object, lift.Object);
        ...
        public void WhenConsumeExpectRaiseEvent()
        {
            ...
            consumer.Consume(new CabinetNotIdleEvent());

            lift.Verify(
                l => l.Report(
                    It.Is<IDevice>(d => device.Object == d),
                    It.Is<string>(e => e == EventCode.G2S_CBE329),
