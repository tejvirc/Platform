namespace Aristocrat.Monaco.G2S.Tests.Consumers
{
    ...
    [TestClass]
    public class OperatingHoursEnabledConsumerTest
    {
        [TestInitialize]
        ...
        {
            var consumer = new OperatingHoursEnabledConsumer(null, null, null);
        ...
        public void WhenCommandBuilderIsNullExpectException()
        {
            ...
            var consumer = new OperatingHoursEnabledConsumer(egm.Object, null, null);
        ...
        public void WhenEventLiftIsNullExpectException()
        {
            ...
            var consumer = new OperatingHoursEnabledConsumer(egm.Object, builder.Object, null);
        ...
        public void WhenParamsAreValidExpectSuccess()
        {
            ...
            var consumer = new OperatingHoursEnabledConsumer(egm.Object, builder.Object, lift.Object);
        ...
        public void WhenConsumeExpectRaiseEvent()
        {
            ...
            consumer.Consume(new OperatingHoursEnabledEvent());

            device.Verify(d => d.RemoveCondition(device.Object, EgmState.EgmDisabled));
