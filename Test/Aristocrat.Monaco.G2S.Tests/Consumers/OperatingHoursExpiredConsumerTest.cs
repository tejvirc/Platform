namespace Aristocrat.Monaco.G2S.Tests.Consumers
{
    ...
    [TestClass]
    public class OperatingHoursExpiredConsumerTest
    {
        [TestInitialize]
        ...
        {
            var consumer = new OperatingHoursExpiredConsumer(null, null, null);
        ...
        public void WhenCommandBuilderIsNullExpectException()
        {
            ...
            var consumer = new OperatingHoursExpiredConsumer(egm.Object, null, null);
        ...
        public void WhenEventLiftIsNullExpectException()
        {
            ...
            var consumer = new OperatingHoursExpiredConsumer(egm.Object, builder.Object, null);
        ...
        public void WhenParamsAreValidExpectSuccess()
        {
            ...
            var consumer = new OperatingHoursExpiredConsumer(egm.Object, builder.Object, lift.Object);
        ...
        public void WhenConsumeExpectRaiseEvent()
        {
            ...
            consumer.Consume(new OperatingHoursExpiredEvent());

            device.Verify(d => d.AddCondition(device.Object, EgmState.EgmDisabled));

            lift.Verify(
                l => l.Report(
                    It.Is<IDevice>(d => device.Object == d),
                    It.Is<string>(e => e == EventCode.GTK_CBE003),
