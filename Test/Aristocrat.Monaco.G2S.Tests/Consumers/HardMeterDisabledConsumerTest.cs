namespace Aristocrat.Monaco.G2S.Tests.Consumers
{
    ...
    [TestClass]
    public class HardMeterDisabledConsumerTest
    {
        [TestInitialize]
        ...
        {
            var consumer = new HardMeterDisabledConsumer(null, null, null);
        ...
        public void WhenCommandBuilderIsNullExpectException()
        {
            ...
            var consumer = new HardMeterDisabledConsumer(egm.Object, null, null);
        ...
        public void WhenEventLiftIsNullExpectException()
        {
            ...
            var consumer = new HardMeterDisabledConsumer(egm.Object, builder.Object, null);
        ...
        public void WhenParamsAreValidExpectSuccess()
        {
            ...
            var consumer = new HardMeterDisabledConsumer(egm.Object, builder.Object, lift.Object);
        ...
        public void WhenConsumeExpectRaiseEvent()
        {
            ...
            consumer.Consume(new DisabledEvent(DisabledReasons.System));

            lift.Verify(
                l => l.Report(
                    It.Is<IDevice>(d => device.Object == d),
                    It.Is<string>(e => e == EventCode.G2S_CBE326),
