namespace Aristocrat.Monaco.G2S.Tests.Handlers.Downloads
{
    ...
    [TestClass]
    public class ResumePackageTransferTest
    {
        [TestMethod]
        [ExpectedException(typeof(ArgumentNullException))]
        public void WhenConstructWithNullEgmExpectException()
        {
            var handler = new ResumePackageTransfer(null, null);
        ...
        public void WhenConstructWithNullPackageManagerExpectException()
        {
            ...
            var handler = new ResumePackageTransfer(egm.Object, null);
        ...
        public void WhenConstructWithValidParamsExpectSuccess()
        {
            ...
            var handler = new ResumePackageTransfer(egm.Object, packageManager.Object);
        ...
        public async Task WhenVerifyWithExpiredCommandExpectError()
        {
            ...
            var packageManager = new Mock<IPackageManager>();
            var handler = new ResumePackageTransfer(egm, packageManager.Object);
