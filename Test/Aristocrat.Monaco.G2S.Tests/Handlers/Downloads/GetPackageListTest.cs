namespace Aristocrat.Monaco.G2S.Tests.Handlers.Downloads
{
    ...
    public class GetPackageListTest
    {
        ...
        {
            var handler = new GetPackageList(null, null, null);
        ...
        public void WhenConstructWithNullPackageManagerExpectException()
        {
            ...
            var handler = new GetPackageList(egm.Object, null, null);
        ...
        public void WhenConstructWithNullCommandBuilderExpectException()
        {
            ...
            var handler = new GetPackageList(egm.Object, packageManager.Object, null);
        ...
        public void WhenConstructWithValidParamsExpectSuccess()
        {
            ...
            var handler = new GetPackageList(egm.Object, packageManager.Object, commandBuilder.Object);
        ...
        public async Task WhenVerifyWithExpiredCommandExpectError()
        {
            ...
            var packageManager = new Mock<IPackageManager>();
            var commandBuilder = new Mock<ICommandBuilder<IDownloadDevice, packageStatus>>();
            var handler = new GetPackageList(egm, packageManager.Object, commandBuilder.Object);
