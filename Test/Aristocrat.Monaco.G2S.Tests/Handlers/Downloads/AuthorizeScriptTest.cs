namespace Aristocrat.Monaco.G2S.Tests.Handlers.Downloads
{
    ...
    [TestClass]
    public class AuthorizeScriptTest
    {
        [TestMethod]
        [ExpectedException(typeof(ArgumentNullException))]
        public void WhenConstructWithNullEgmExpectException()
        {
            var handler = new AuthorizeScript(null, null, null, null, null);
        ...
        public void WhenConstructWithNullPackageManagerExpectException()
        {
            ...
            var handler = new AuthorizeScript(egm.Object, null, null, null, null);
        ...
        public void WhenConstructWithNullScriptManagerExpectException()
        {
            ...
            var handler = new AuthorizeScript(egm.Object, packageManager.Object, null, null, null);
        ...
        public void WhenConstructWithNullEventLiftExpectException()
        {
            ...
            var handler = new AuthorizeScript(egm.Object, packageManager.Object, scriptManager.Object, null, null);
        ...
        public void WhenConstructWithNullScriptCommandExpectException()
        {
            ...
            var handler = new AuthorizeScript(
                egm.Object,
