namespace Aristocrat.Monaco.Bingo.Tests.Consumers
{
    ...
    [TestClass]
    public class IdReaderHardwareFaultClearedConsumerTests
    {
        private IdReaderHardwareFaultClearConsumer _target;
        ...
        private readonly HardwareFaultClearEvent _event = new(IdReaderFaultTypes.OtherFault);

        [TestInitialize]
        public void MyTestInitialize()
        {
            _target = new IdReaderHardwareFaultClearConsumer(_eventBus.Object, _consumerContext.Object, _reportingService.Object);
        }
        ...
        {
            _target = new IdReaderHardwareFaultClearConsumer(
        ...
        {
            _reportingService.Setup(m => m.AddNewEventToQueue(ReportableEvent.CardReaderErrorClear)).Verifiable();

            _target.Consume(_event);

            _reportingService.Verify(m => m.AddNewEventToQueue(ReportableEvent.CardReaderErrorClear), Times.Once());
        }
    }
}