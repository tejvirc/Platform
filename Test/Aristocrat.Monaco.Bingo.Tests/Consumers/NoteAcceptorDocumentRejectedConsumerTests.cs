namespace Aristocrat.Monaco.Bingo.Tests.Consumers
{
    ...
    public class NoteAcceptorDocumentRejectedConsumerTests
    {
        ...
        private readonly DocumentRejectedEvent _event = new();

        [TestInitialize]
        public void MyTestInitialize()
        {
            _target = new NoteAcceptorDocumentRejectedConsumer(_eventBus.Object, _consumerContext.Object, _reportingService.Object);
        }
        ...
        {
            _target = new NoteAcceptorDocumentRejectedConsumer(
        ...
        {
            _reportingService.Setup(m => m.AddNewEventToQueue(ReportableEvent.BillAcceptorDocumentRejected)).Verifiable();

            _target.Consume(_event);

            _reportingService.Verify(m => m.AddNewEventToQueue(ReportableEvent.BillAcceptorDocumentRejected), Times.Once());
        }
    }
}