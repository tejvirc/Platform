namespace Aristocrat.Monaco.Bingo.Tests.Consumers
{
    ...
    [TestClass]
    public class IdPresentedConsumerTests
    {
        private IdPresentedConsumer _target;
        ...
        private readonly IdPresentedEvent _event = new (111);

        [TestInitialize]
        public void MyTestInitialize()
        {
            _target = new IdPresentedConsumer(_eventBus.Object, _consumerContext.Object, _reportingService.Object);
        }
        ...
        {
            _target = new IdPresentedConsumer(
        ...
        {
            _reportingService.Setup(m => m.AddNewEventToQueue(ReportableEvent.CardInserted)).Verifiable();

            _target.Consume(_event);

            _reportingService.Verify(m => m.AddNewEventToQueue(ReportableEvent.CardInserted), Times.Once());
        }
    }
}