namespace Aristocrat.Monaco.Bingo.Tests.Consumers
{
    ...
    [TestClass]
    public class NoteAcceptorVoucherReturnedConsumerTests
    {
        private NoteAcceptorVoucherReturnedConsumer _target;
        ...
        private readonly VoucherReturnedEvent _event = new(string.Empty);

        [TestInitialize]
        public void MyTestInitialize()
        {
            _target = new NoteAcceptorVoucherReturnedConsumer(_eventBus.Object, _consumerContext.Object, _reportingService.Object);
        }
        ...
        {
            _target = new NoteAcceptorVoucherReturnedConsumer(
        ...
        {
            _reportingService.Setup(m => m.AddNewEventToQueue(ReportableEvent.BillAcceptorDocumentReturned)).Verifiable();

            _target.Consume(_event);

            _reportingService.Verify(m => m.AddNewEventToQueue(ReportableEvent.BillAcceptorDocumentReturned), Times.Once());
        }
    }
}