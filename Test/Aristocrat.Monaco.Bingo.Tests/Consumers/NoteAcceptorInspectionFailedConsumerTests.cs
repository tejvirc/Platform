namespace Aristocrat.Monaco.Bingo.Tests.Consumers
{
    ...
    [TestClass]
    public class NoteAcceptorInspectionFailedConsumerTests
    {
        private NoteAcceptorInspectionFailedConsumer _target;
        ...
        {
            _target = new NoteAcceptorInspectionFailedConsumer(_eventBus.Object, _consumerContext.Object, _reportingService.Object);
        }
        ...
        {
            _target = new NoteAcceptorInspectionFailedConsumer(
