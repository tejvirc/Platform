namespace Aristocrat.Monaco.Bingo.Tests.Consumers
{
    ...
    [TestClass]
    public class PrintStartedConsumerTests
    {
        private PrintStartedConsumer _target;
        ...
        private readonly PrintStartedEvent _event = new();
        ...
        private PrintStartedConsumer CreateTarget(
            bool nullEventBus = false,
            bool nullProperties = false,
            bool nullCommandFactory = false)
        {
            return new PrintStartedConsumer(
