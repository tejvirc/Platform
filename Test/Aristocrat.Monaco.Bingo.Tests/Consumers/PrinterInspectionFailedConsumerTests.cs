namespace Aristocrat.Monaco.Bingo.Tests.Consumers
{
    ...
    [TestClass]
    public class PrinterInspectionFailedConsumerTests
    {
        private PrinterInspectionFailedConsumer _target;
        ...
        {
            _target = new PrinterInspectionFailedConsumer(_eventBus.Object, _consumerContext.Object, _reportingService.Object);
        }
        ...
        {
            _target = new PrinterInspectionFailedConsumer(
