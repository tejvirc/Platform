namespace Aristocrat.Monaco.Bingo.Tests.Consumers
{
    ...
    public class NoteAcceptorCurrencyReturnedConsumerTests
    {
        ...
        private readonly CurrencyReturnedEvent _event = new(null);

        [TestInitialize]
        public void MyTestInitialize()
        {
            _target = new NoteAcceptorCurrencyReturnedConsumer(_eventBus.Object, _consumerContext.Object, _reportingService.Object);
        }
        ...
        {
            _target = new NoteAcceptorCurrencyReturnedConsumer(
