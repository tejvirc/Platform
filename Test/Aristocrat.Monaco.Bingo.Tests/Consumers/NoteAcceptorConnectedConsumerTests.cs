namespace Aristocrat.Monaco.Bingo.Tests.Consumers
{
    ...
    [TestClass]
    public class NoteAcceptorConnectedConsumerTests
    {
        private NoteAcceptorConnectedConsumer _target;
        ...
        private readonly ConnectedEvent _event = new();
        ...
        private NoteAcceptorConnectedConsumer CreateTarget(bool nullEventBus = false, bool nullCommandFactory = false)
        {
            return new NoteAcceptorConnectedConsumer(
