namespace Aristocrat.Monaco.Bingo.Tests.Monitors
{
    ...
    [TestClass]
    public class HandPaidGameWinBonusAmountMeterMonitorTests
    {
        ...
        private HandPaidGameWinBonusAmountMeterMonitor _target;

        [TestInitialize]
        public void Initialize()
        {
            _meter = new TestMeter(GamingMeters.HandPaidGameWonAmount, MockClassification);
            _meterManager.Setup(m => m.GetMeter(BonusMeters.HandPaidGameWinBonusAmount)).Returns(_meter);
        ...
        [TestMethod]
        public void ReportTransactionHandpayCreditTest()
        {
            const long amount = 12340000;
            const int paytableId = 123;
            const long gameSerial = 123456789;
        ...
        [TestMethod]
        public void ReportTransactionHandpayTest()
        {
            const long amount = 12340000;
            const int paytableId = 123;
            const long gameSerial = 123456789;
            ...
            var handpayTransactions = new List<HandpayTransaction>
            {
                ...
                {
                    Barcode = barcode,
                    KeyOffType = KeyOffType.LocalHandpay,
                    KeyOffCashableAmount = amount,
                    AssociatedTransactions = new []{ bonusTransactionId }
                }
            };
        ...
        private HandPaidGameWinBonusAmountMeterMonitor CreateTarget(
        ...
        {
            return new HandPaidGameWinBonusAmountMeterMonitor(
