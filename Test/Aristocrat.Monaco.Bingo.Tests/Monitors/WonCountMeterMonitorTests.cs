namespace Aristocrat.Monaco.Bingo.Tests.Monitors
{
    ...
    [TestClass]
    public class WonCountMeterMonitorTests
    {
        ...
        {
            _meter = new TestMeter(GamingMeters.WonCount, MockClassification);
            _meterManager.Setup(m => m.GetMeter(GamingMeters.WonCount)).Returns(_meter);
