namespace Aristocrat.Monaco.Bingo.Tests.Monitors
{
    ...
    [TestClass]
    public class HandPaidGameWonAmtMonitorTests
    {
        ...
        private HandPaidGameWonAmtMeterMonitor _target;

        [TestInitialize]
        public void Initialize()
        {
            _meter = new TestMeter(GamingMeters.HandPaidGameWonAmount, MockClassification);
            _meterManager.Setup(m => m.GetMeter(GamingMeters.HandPaidGameWonAmount)).Returns(_meter);
        ...
        [TestMethod]
        public void ReportTransactionHandpayCreditOnlyTest()
        {
            const long amount = 12340000;
            const int paytableId = 123;
            const long gameSerial = 123456789;
        ...
        private HandPaidGameWonAmtMeterMonitor CreateTarget(
        ...
        {
            return new HandPaidGameWonAmtMeterMonitor(
