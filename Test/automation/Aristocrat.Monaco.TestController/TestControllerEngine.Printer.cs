namespace Aristocrat.Monaco.TestController
{
    ...
    public partial class TestControllerEngine
    {
        ...
        public Dictionary<string, object> PrinterConnect(string id)
        {
            bool result = false;
        ...
        public Dictionary<string, object> PrinterDisconnect(string id)
        {
            bool result = false;
            var printer = ServiceManager.GetInstance().GetService<IPrinter>();
        ...
        public Dictionary<string, object> PrinterJam([FromRoute] string id)
        {
        ...
        public Dictionary<string, object> PrinterEmpty(string id)
        {
        ...
        public Dictionary<string, object> PrinterPaperInChute(string id)
        {
        ...
        public Dictionary<string, object> PrinterStatus(string id)
        {
        ...
        public Dictionary<string, object> PrinterPaperStatus(string id)
        {
            var faults = Enum.GetValues(typeof(PrinterFaultTypes)).Cast<PrinterFaultTypes>()
                .Where(val => (val & _printerFaults) != 0).ToList();
        ...
        public Dictionary<string, object> PrinterChassisOpen(string id)
        {
        ...
        public Dictionary<string, object> PrinterPaperLow(string id)
        {
        ...
        public Dictionary<string, object> PrinterPaperFill(string id)
        {
        ...
        public Dictionary<string, object> PrinterGetTicketList(string id, string count = "1")
        {
        ...
        public Dictionary<string, object> PrinterTicketRemove(string id)
        {
        ...
        public Dictionary<string, object> PrinterHeadLift(string id)
        {
        ...
        public Dictionary<string, object> PrinterHeadLower(string id)
        {
