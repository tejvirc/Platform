namespace Aristocrat.Monaco.Application.UI.StatusDisplay
{
    ...
    /// </summary>
    public sealed class StatusDisplayMessageHandler : IMessageDisplayHandler, IDisposable
    {
        ...
        /// <summary>
        ///     Initializes a new instance of the <see cref="StatusDisplayMessageHandler" /> class.
        /// </summary>
        /// <param name="display">The display to which to forward messages.</param>
        public StatusDisplayMessageHandler(StatusDisplayView display)
        {
