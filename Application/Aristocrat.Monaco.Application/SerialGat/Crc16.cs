namespace Aristocrat.Monaco.Application.SerialGat
{
    ...
    /// <summary>
    /// 16-bit CRC with polynomial 1 + x^2 + x^15 + x^16 and seed of 0xffff.
    /// </summary>
    public class SerialGatCrc16
    {
        ...
        public void Hash(byte[] bytes, int start, int count)
        {
        ...
        public void HashByte(byte b)
        {
            var aa = (ushort)(Crc >> 8);
            var bb = (ushort)(Crc ^ b);
            var cc = (ushort)(bb & 0xff);
            Crc = (ushort)(aa ^ Table[cc]);
        }
