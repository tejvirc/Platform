...
{
    /// <summary>
    ///     Indicates the game is not in play (not in a game-cycle), player input is enabled, player may leave the game and
    ...
    /// </summary>
    public class GameIdleEvent : BaseGameEvent
    {
        /// <summary>
        ///     Initializes a new instance of the <see cref="GameIdleEvent" /> class.
        /// </summary>
        ...
        public GameIdleEvent(int gameId, long denomination, string wagerCategory, IGameHistoryLog log)
