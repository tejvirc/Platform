namespace Aristocrat.Monaco.Gaming.Contracts.Progressives.Linked
{
    ...
    /// </summary>
    public class LinkedProgressiveCommitEvent : LinkedProgressiveEvent
    {
        /// <summary>
        ///     Gets the level.
        /// </summary>
        ...
        /// <inheritdoc />
        public LinkedProgressiveCommitEvent(IViewableProgressiveLevel level, IEnumerable<IViewableLinkedProgressiveLevel> linkedLevels, ICloneable jackpot)
            : base(linkedLevels)
        {
            Level = level;
