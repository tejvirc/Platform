namespace Aristocrat.Monaco.Gaming.Contracts.Meters
{
    ...
    /// <summary>
    ///     Definition of the GameCompositeMeterNode class.
    /// </summary>
    [CLSCompliant(false)]
    public class GameCompositeMeterNode : ExtensionNode
    {
#pragma warning disable 0649 // Fields are initialized by MonoAddins
        ...
        /// <summary>
        ///     The composite meter's expression.
        /// </summary>
        ...
        /// <summary>
        ///     Gets the expression of the composite meter.
        /// </summary>
