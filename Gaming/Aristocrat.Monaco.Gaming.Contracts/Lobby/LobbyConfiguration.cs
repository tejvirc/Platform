...
public partial class LobbyConfiguration {
    ...
    private string lcdInsertMoneyVideoField;
    
    private string lcdChooseVideoField;
    ...
    /// <remarks/>
    public string LcdInsertMoneyVideo {
        get {
            return this.lcdInsertMoneyVideoField;
        }
        set {
            this.lcdInsertMoneyVideoField = value;
        }
    }
    
    /// <remarks/>
    public string LcdChooseVideo {
        get {
            return this.lcdChooseVideoField;
        }
        set {
            this.lcdChooseVideoField = value;
        }
    }
