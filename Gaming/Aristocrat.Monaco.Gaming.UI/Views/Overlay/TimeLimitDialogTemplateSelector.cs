namespace Aristocrat.Monaco.Gaming.UI.Views.Overlay
{
    ...
    /// </summary>
    public class TimeLimitDialogTemplateSelector : DataTemplateSelector
    {
        /// <inheritdoc />
        public override DataTemplate SelectTemplate(object item, DependencyObject container)
        {
            ...
            return element?.TryFindResource(viewModel.Config.TimeLimitDialogTemplate) as DataTemplate;
        }
    }
}
