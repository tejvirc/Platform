            ...
            lock (_sync)
            {
                foreach (var result in results)
                {
                    ...
                    var gameDetail = new GameDetail
                    {
                        ...
                        MinimumPaybackPercent = decimal.Parse((string)gameInfo[GameMinimumPaybackPercentField]),
                        MaximumPaybackPercent = decimal.Parse((string)gameInfo[GameMaximumPaybackPercentField])
                    };
