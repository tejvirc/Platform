...
/// </remarks>
public record InfoBarDisplayTransientMessageAction
{
    /// <summary>
    ...
    /// <summary>
    ///     Initializes a new instance of the <see cref="InfoBarDisplayTransientMessageAction" /> record.
    /// </summary>
    ...
    public InfoBarDisplayTransientMessageAction(
        Guid ownerId,
        string message,
        TimeSpan duration,
    ...
    /// <summary>
    ///     Initializes a new instance of the <see cref="InfoBarDisplayTransientMessageAction" /> class.
    /// </summary>
    /// <param name="ownerId">The owner ID.</param>
    /// <param name="message">The message to display on the InfoBar.</param>
    /// <param name="textColor">Color of the text.</param>
