...
{
    /// <summary>
    ///     Gets the current idle text to display
    /// </summary>
    public static readonly ISelector<BannerState, string?> CurrentIdleTextSelector = CreateSelector(
        (BannerState s) => s.CurrentIdleText);
    ...
    /// <summary>
    ///     Gets whether or not the idle text is in scrolling mode and actively scrolling still (in case need to wait for
    ///     finish)
    /// </summary>
