...
//public class LobbyPackageWeb : Prism.PrismBootstrapperBase//, IPackage
//{
...
//        var runTask = Task.Run(() => base.Run())
//            .ContinueWith(_ => app.StopAsync().Wait());

//        runTask.FireAndForget();
...
//        services.AddSingleton<Services.Attendant.IAttendantAgent, AttendantAgent>();
...
//    protected override IContainerExtension CreateContainerExtension() => new LobbyContainerExtension();

//    protected override void RegisterTypes(IContainerRegistry containerRegistry)
//    {
//    }

//    protected override DependencyObject CreateShell() => null;
//        // ContainerLocator.Container.Resolve<ILayoutManager>().ShellWindow;
//}
