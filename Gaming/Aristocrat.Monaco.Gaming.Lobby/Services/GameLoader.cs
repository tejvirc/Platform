...
public class GameLoader : IGameLoader
{
    ...
    public GameLoader(IPropertiesManager properties, LobbyConfiguration configuration, IGameOrderSettings gameOrderSettings)
    {
    ...
    private void SetGameOrderFromConfig(IEnumerable<IGameDetail> games)
    {
        ...
        _gameOrderSettings.SetGameOrderFromConfig(
            ...
            _configuration.DefaultGameDisplayOrderByThemeId.ToList());
    }
    ...
    private IEnumerable<GameInfo> GetOrderedGames(ICollection<IGameDetail> games)
    {
        ...
        var gameCombos = (from game in games
            ...
            select new GameInfo
            {
                ...
                ImagePath = games.Count > 8
                    ? game.LocaleGraphics.Values.First().SmallIcon
                    : game.LocaleGraphics.Values.First().LargeIcon,
                ...
                FilteredDenomination =
                    _configuration?.MinimumWagerCreditsAsFilter ?? false ? game.MinimumWagerCredits * denom : denom,
