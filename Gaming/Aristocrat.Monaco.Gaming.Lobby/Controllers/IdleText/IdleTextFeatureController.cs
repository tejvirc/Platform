namespace Aristocrat.Monaco.Gaming.Lobby.Features.IdleText;
...
public class IdleTextFeatureController
{
    ...
    public IdleTextFeatureController(IDispatcher dispatcher, IEventBus eventBus, IPropertiesManager properties)
    {
