namespace Aristocrat.Monaco.Accounting.Contracts
{
    ...
    /// <summary>
    /// Keyed Off Credits Transaction Class
    /// </summary>
    public class KeyedOffCreditsTransaction : BaseTransaction
    {
        ...
        /// </summary>
        public static string KeyedType =>  Localizer.For(CultureFor.OperatorTicket).GetString(ResourceKeys.KeyedOff);
        ...
        public override void SetPersistence(IPersistentStorageAccessor block, int element)
        {
            ...
            using (var storageTransaction = block.StartTransaction())
            {
                storageTransaction[element, "TransferredNonCashAmount"] = TransferredNonCashAmount;
                storageTransaction[element, "TransferredPromoAmount"] = TransferredPromoAmount;
                storageTransaction[element, "AccountType"] = (byte)AccountType;
                storageTransaction[element, "TransferredCashableAmount"] = TransferredCashableAmount;
            }
        }
    }
}
