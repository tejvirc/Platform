namespace Generator
{
    ...
    public partial class CircleLoader : UserControl
    {
        public static readonly DependencyProperty MinimumProperty =
            DependencyProperty.Register("Minimum", typeof(int), typeof(CircleLoader), new UIPropertyMetadata(1));

        public static readonly DependencyProperty MaximumProperty =
            DependencyProperty.Register("Maximum", typeof(int), typeof(CircleLoader), new UIPropertyMetadata(1));

        public static readonly DependencyProperty ValueProperty =
            DependencyProperty.Register("Value", typeof(int), typeof(CircleLoader), new UIPropertyMetadata(100));
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CircleLoader"/> class.
        /// </summary>
        public CircleLoader()
        {
            InitializeComponent();
