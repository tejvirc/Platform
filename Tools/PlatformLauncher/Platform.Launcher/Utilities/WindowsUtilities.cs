    ...
    internal class WindowsUtilities
    {
        ...
        public static void Reboot()
        {
            ...
            try
            {
                ...
                privileges.Privileges[0].Attributes = SePrivilegeEnabled;

                if (!LookupPrivilegeValue(null, SeShutdownName, out privileges.Privileges[0].Luid))
        ...
        [DllImport("advapi32.dll", SetLastError = true)]
        [return: MarshalAs(UnmanagedType.Bool)]
        private static extern bool AdjustTokenPrivileges(IntPtr tokenHandle, [MarshalAs(UnmanagedType.Bool)] bool disableAllPrivileges, ref TokenPrivileges newState, uint zero, IntPtr null1, IntPtr null2);
