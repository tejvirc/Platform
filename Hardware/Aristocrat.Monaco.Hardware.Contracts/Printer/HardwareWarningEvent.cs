namespace Aristocrat.Monaco.Hardware.Contracts.Printer
{
    ...
    /// <summary> Definition of the HardwareWarningEvent class.</summary>
    /// <remarks>
    ...
    /// </remarks>
    [Serializable]
    public class HardwareWarningEvent : PrinterBaseEvent
    {
        /// <summary>
        ///     Initializes a new instance of the <see cref="HardwareWarningEvent" /> class.
        /// </summary>
        /// <param name="warning">The warning.</param>
        public HardwareWarningEvent(PrinterWarningTypes warning)
        {
            Warning = warning;
        }
        ...
        /// <param name="warning">The warning.</param>
        public HardwareWarningEvent(int printerId, PrinterWarningTypes warning)
            : base(printerId)
        {
            Warning = warning;
        }
        ...
        public override string ToString()
        {
            ...
            {
                return PrinterEventsDescriptor.WarningTexts[Warning];
            }
