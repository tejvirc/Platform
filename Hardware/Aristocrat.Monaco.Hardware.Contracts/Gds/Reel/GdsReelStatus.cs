namespace Aristocrat.Monaco.Hardware.Contracts.Gds.Reel
{
    ...
    [Serializable]
    public class GdsReelStatus : GdsSerializableMessage, IEquatable<GdsReelStatus>, ICloneable
    {
        /// <summary>Constructor</summary>
        public GdsReelStatus()
        ...
        /// <inheritdoc />
        public bool Equals(GdsReelStatus other)
        {
        ...
        public override bool Equals(object obj)
        {
            return !ReferenceEquals(null, obj) &&
                   (ReferenceEquals(this, obj) || obj.GetType() == GetType() && Equals((GdsReelStatus)obj));
        }
        ...
        /// <summary>
        ///     Converts the GdsReelStatus to a ReelStatus
        /// </summary>
        /// <returns>The controller reel status</returns>
        public ReelStatus ToReelStatus()
        {
            return new ReelStatus
            {
                ReelId = ReelId,
                Connected = Connected,
                FailedHome = FailedHome,
                LowVoltage = LowVoltage,
                ReelStall = ReelStall,
                ReelTampered = ReelTampered
            };
        }
    }
}